...
extern const uint32_t RX_FIFO_SIZE;
extern const uint32_t TX0_FIFO_SIZE;
extern const uint32_t TX1_FIFO_SIZE;
extern const uint32_t TX2_FIFO_SIZE;
extern const uint32_t TX3_FIFO_SIZE;
