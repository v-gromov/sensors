...
extern inline void gpio_set( u32 gpioport, u16 gpios)
{
	GPIO_BSRR(gpioport) = gpios;
}

extern inline void gpio_clear( u32 gpioport, u16 gpios)
{
	GPIO_BRR(gpioport) = gpios;
}

extern inline u16 gpio_port_read( u32 gpioport)
{
	return (u16)GPIO_IDR(gpioport);
}

extern inline void gpio_port_write( u32 gpioport, u16 data)
{
	GPIO_ODR(gpioport) = data;
}

extern inline u16 gpio_get( const u32 gpioport, u16 gpios)
{
